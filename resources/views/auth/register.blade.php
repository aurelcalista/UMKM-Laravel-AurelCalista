...
.sl-input-icon input{
  ...
  @media (max-width: 900px) {
    ...
    .sl-form-panel { padding: 2.5rem 2rem; }
...
<div class="sl-page">
  ...
  {{-- LEFT: Visual --}}
  <div class="sl-visual">
    <img src="https://images.unsplash.com/photo-1547592180-85f173990554?w=900&auto=format&fit=crop" alt="Korean food">
  ...
  <div class="sl-form-panel">
    ...
    <div class="sl-form-inner">
      ...
      <p class="sl-form-sub">
        Daftar gratis dan mulai memesan
      </p>

      <div class="sl-tabs">
        <a href="{{ route('login') }}" class="sl-tab">
          Masuk
        </a>
